...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { listo: @tarea.listo, nombre: @tarea.nombre, subida: @tarea.subida } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { listo: @tarea.listo, nombre: @tarea.nombre, subida: @tarea.subida } }
